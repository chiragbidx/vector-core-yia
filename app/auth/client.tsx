...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your WalkBuddy account",
        description: "Start managing your dog walking business today.",
        button: "Get Started",
        helper: {
    ...
    return {
      id: "signin",
      title: "Sign in to WalkBuddy",
      description: "Manage your dog walks and clients easily.",
      button: "Sign In",
      helper: {
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Hassle-free dog walking management for modern professionals.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                WalkBuddy helps dog walkers and owners coordinate walks, manage client profiles, and handle payments with ease—all in one simple dashboard.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-secondary/70 bg-background/80 p-3 shadow-lg">
              <Image
                src="/demo-img.jpg"
                alt="WalkBuddy dashboard preview"
          ...
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="mt-2 flex justify-center gap-1 text-xs text-muted-foreground">
                {content.helper.text}
                <Link href={`/auth${content.helper.href}`} className="font-semibold text-primary hover:underline">
                  {content.helper.action}
                </Link>
              </div>
            </CardContent>
          </Card>
